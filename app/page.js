  ...
  return (
    <div>
      ...
      <div className="mt-10 grid sm:grid-cols-3 gap-4">
        <a
          href="/study"
          className="punch-edge block bg-card border border-ink/10 rounded-card p-6 hover:border-rule transition-colors"
        >
          <p className="font-mono text-xs text-rule mb-2">01</p>
          <h2 className="font-display text-xl text-ink">Study Mode</h2>
        ...
        >
          ...
          <h2 className="font-display text-xl text-ink">Browse Bank</h2>
          <p className="text-sm text-ink/60 mt-2">
        ...
        >
          ...
          <h2 className="font-display text-xl text-ink">Add Question</h2>
          <p className="text-sm text-ink/60 mt-2">
